    ...
    <div className="flex flex-col gap-8 w-3/4">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-gray-500">
          ...
          <span className="text-black break-all">{email}</span>
          {onBack && (
            <button
              type="button"
              onClick={onBack}
              className="text-blue-600 font-medium cursor-pointer ml-3 underline-offset-4 hover:underline"
            >
              Edit
            </button>
          )}
      ...
      <Form {...form}>
        ...
        >
              ...
              <FormItem className="flex flex-col items-center">
                <FormControl>
                  <InputOTP
                    ...
                    aria-invalid={!!form.formState.errors.resetCode}
                  >
                    <InputOTPGroup>
          ...
          {counter > 0 ? (
            <p className="text-gray-500 flex justify-center" aria-live="polite">
              You can request another code in:{" "}
              <span className="font-semibold ml-1">{counter}s</span>
            </p>
          ) : (
